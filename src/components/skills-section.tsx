...
const skillCategories: SkillCategory[] = [
	{
		...
		skills: [
			{ name: "React", startYear: 2020, category: "frontend" },
			{ name: "Next.js", startYear: 2021, category: "frontend" },
			{ name: "CSS/Tailwind", startYear: 2019, category: "frontend" },
			{ name: "HTML", startYear: 2019, category: "frontend" },
		],
	},
	{
		...
		skills: [
			{ name: "Node.js", startYear: 2020, category: "backend" },
			{ name: "Express", startYear: 2020, category: "backend" },
			{ name: "NestJS", startYear: 2021, category: "backend" },
			{ name: "WebSockets", startYear: 2020, category: "backend" },
		],
	},
	{
		name: "Database",
		...
		skills: [
			{ name: "PostgreSQL", startYear: 2020, category: "database" },
			{ name: "MySQL", startYear: 2021, category: "database" },
			{ name: "MongoDB", startYear: 2021, category: "database" },
			{ name: "Redis", startYear: 2022, category: "database" },
			{ name: "RabbitMQ", startYear: 2023, category: "database" },
		],
	},
	{
		name: "Languages",
		...
		skills: [
			{ name: "JavaScript", startYear: 2019, category: "languages" },
			{ name: "TypeScript", startYear: 2020, category: "languages" },
	...
	},
	{
		...
		skills: [
			...
			{ name: "Docker", startYear: 2022, category: "devops" },
		],
	},
	{
		name: "Other Skills",
		...
		skills: [
			{ name: "Git/GitHub", startYear: 2019, category: "tools" },
